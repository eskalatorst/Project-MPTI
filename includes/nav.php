                ...
                <div class="align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-left text-left" id="menu">
                        ...
                        <li class="nav-item">
                            <div class="row">
                                <div class="col-2 pb-1">
                                    <img style="width: 20px;" src="../assets/img/customer.png" alt="Penghuni Icon">
                                </div>
                                <div class="col-10">
                        ...
                        <li class="nav-item">
                            <div class="row">
                                <div class="col-2 pb-1">
                                    <img style="width: 20px;" src="../assets/img/riwayat.png" alt="Pengaturan Icon">
                                </div>
                                <div class="col-10">
                                    <a class="nav-menu nav-link text-white" href="../pages/riwayat.php">Riwayat</a>
                                </div>
                            </div>
                        </li>
                        <li class="nav-item">
                            <div class="row">
                                <div class="col-2 pb-1">
                                    <img style="width: 20px;" src="../assets/img/user2.png" alt="Profil icon">
                                </div>
                                <div class="col-10">
                                    <a class="nav-menu nav-link text-white" href="../pages/profile.php">Profil</a>
                                </div>
                            </div>
                        </li>
                    </ul>
